...
namespace pickle::v0 {
    ...
    public:
        ...
        void PrefetchAdj(internal_id_t vid) {
            _mm_prefetch(m_adj_list.data() + m_max_deg * vid, _MM_HINT_T0);
            _mm_prefetch(m_adj_list.data() + m_max_deg * vid + 64 / sizeof(internal_id_t ), _MM_HINT_T0);
        };
